...
function Interface.Criar(player)
    ...
    main.BackgroundColor3 = Color3.fromRGB(12, 12, 35)
    ...
    exitBtn.Position = UDim2.new(1, -32, 0, 12)
    exitBtn.Text = "✖"
    ...
    -- Retorna objetos para serem usados pelas categorias
    return {
        gui = gui,
        main = main,
        content = content,
